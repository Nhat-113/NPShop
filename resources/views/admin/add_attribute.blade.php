                    ...
                    <form action=" {{URL::to('/save-attribute/'.$product_by_id->product_id)}} " method="post">
                        ...
                        {{-- <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="product_sku" value="{{$stock}}" class="form-control" disabled placeholder="">
                            </div>
                        </div> --}}
                        ...
                        <div class="field_wrapper panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" style="width: 23%; float:left; margin:2px" placeholder="Giá thành" type="text" name="price[]" value=""/>
                                <input class="form-control" style="width: 23%; float:left; margin:2px" placeholder="Kích thước"  type="text" name="size[]" value=""/>
                                <input class="form-control" style="width: 23%; float:left; margin:2px" placeholder="Số lượng"  type="text" name="stock[]" value=""/>
