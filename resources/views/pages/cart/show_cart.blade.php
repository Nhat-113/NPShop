                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <select id="payment_select" name="payment_select" class="form-select payment_select" aria-label="Default select example">
                                                            <option name="payment_option" value="1">Thanh toán bằng thẻ ghi
                                                                nợ</option>
                                                            <option name="payment_option" value="2">Thanh toán bằng thẻ ATM
                                                            </option>
                                                            <option name="payment_option" value="3">Thanh toán bằng tiền mặt
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-4 card-body">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="row pt-1">
                                                <div class="col mb-3">
                                                    ...
                                                    @elseif(Session::get('fee')==false)
                                                        <span class="small text-muted me-2 font-weight-bold">Phí
                                                            ship:</span> <span
                                                            class="lead fw-normal text-warning  font-weight-bold float-end">{{ number_format(20000) . ' VND' }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="row pt-1">
                                                <div class="col mb-1">
                                                    ...
                                                    @elseif ($cou['coupon_condition'] == 0)
                                                        <span class="small text-muted me-2 font-weight-bold">Thành tiền:</span> <span
                                                            class="lead fw-normal text-warning  font-weight-bold float-end">{{ number_format($total - $total_coupon + 20000) . ' VND' }}</span>
                                                    ...
                                                    @elseif($cou['coupon_condition']==1)
                                                        <span class="small text-muted me-2 font-weight-bold">Thành tiền:</span> <span
                                                            class="lead fw-normal text-warning  font-weight-bold float-end">{{ number_format($total_coupon + 20000) . ' VND' }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            @endif
                                            ...
                                            @if (!Session::get('fee') && !Session::get('coupon'))
                                                ...
                                                <span class="small text-muted me-2 font-weight-bold">Thành tiền:</span>
                                                <span
                                                    class="lead fw-normal text-warning  font-weight-bold float-end">{{ number_format($total + 20000) . ' VND' }}</span>
                                            @endif
                                            <hr>
